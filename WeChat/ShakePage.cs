...
namespace WeChat
{
    public class ShakePage: Basic
    {
       ...
       /// <param name="page_url">跳转链接</param>
       /// <returns></returns>
       public bool Update(long page_id, string title, string description, string icon_url, string comment, string page_url)
       {
           icon_url = UploadImage(icon_url);
       ...
       /// <returns></returns>
       public bool Delete(long[] page_ids)
       {
           var ReqStr = JsonConvert.SerializeObject(
               new
               {
       ...
       /// <returns></returns>
       public bool Relate(long device_id,string uuid,long major,long minor,int bind,int append, long[] page_ids)
       {
           var ReqStr = JsonConvert.SerializeObject(
               new
               {
