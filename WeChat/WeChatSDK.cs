   ...
   public class WeChatSDK
    {
        ...
        /// <param name="payment_notice_address">微信支付异步通知回调地址</param>
        public static void Initialize(string app_id, string app_secret,string mch_id,string mch_key,string mch_certPath,string payment_notice_address)
        {
            Basic.app_id = app_id;
            ...
            Basic.payment_notice_address = payment_notice_address;
        }
    }
}
