...
namespace WeChat.Net
{
    public class Ticket : Basic
    {
        ...
        /// <returns></returns>
        public bool Update(string _cardType, string _card_id,
            string _logo_url,
            string _color,
            string _notice,
        ...
        /// <returns></returns>
        public bool ModifyStock(string cardId, int increase_stock_value, int reduce_stock_value)
        {
            var ReqStr = JsonConvert.SerializeObject(
               new
               {
