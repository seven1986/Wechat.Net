...
namespace WeChat.Net.Core
{
    public class POI: Basic
    {
        ...
        /// <returns></returns>
        public bool Delete(long poi_id)
        {
            var ReqStr = JsonConvert.SerializeObject(
               new
               {
        ...
        /// <returns></returns>
        public bool Update(long poi_id, string telephone, string[] photo_list, string recommend,
        ...
        /// <param name="poi_id">门店 ID</param>
        /// <returns></returns>
        public bool Detail(string poi_id)
        {
            var ReqStr = JsonConvert.SerializeObject(
               new
               {
